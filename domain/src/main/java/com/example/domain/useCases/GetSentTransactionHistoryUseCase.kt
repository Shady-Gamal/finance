...
class GetSentTransactionHistoryUseCase @Inject constructor(val transactionHistoryRepository: TransactionHistoryRepository) {

    suspend operator fun invoke(id : String) : Flow<Resource<List<TransactionDTO>>> {

        return transactionHistoryRepository.getSentTransactionHistory(id)
    }
}